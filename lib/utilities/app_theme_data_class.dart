...
class AppThemeDataClass {
  ...
  ThemeData getAppTheme(BuildContext context) {
    double bodyLargeFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double bodyMediumFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double bodySmallFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double displayLargeFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double displayMediumFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double displaySmallFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double titleLargeFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double titleMediumFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
    double titleSmallFontSize = fontSizeCalculator.calculateFontSize(context, 1.0);
...
// Define the default brightness and colors.
      ...
      textTheme: TextTheme(
        ...
        bodyMedium: GoogleFonts.roboto(
          ...
          fontSize: bodyMediumFontSize * 0.25,
          color: const Color(0xFFFFFFFF),
        ),
        ...
        displaySmall: GoogleFonts.roboto(
          fontStyle: FontStyle.normal,
          fontWeight: FontWeight.normal,
          fontSize: displaySmallFontSize * 0.85,
          color: const Color(0xFFFFFFFF),
        ),
        ...
        titleMedium: GoogleFonts.roboto(
          fontStyle: FontStyle.normal,
          fontWeight: FontWeight.bold,
          fontSize: titleMediumFontSize * 0.75,
          color: const Color(0xFF176B87),
        ),
        titleSmall: GoogleFonts.roboto(
          fontStyle: FontStyle.normal,
          fontWeight: FontWeight.bold,
          fontSize: titleSmallFontSize * 0.75,
          color: const Color(0xFF176B87),
        ),
      ),
